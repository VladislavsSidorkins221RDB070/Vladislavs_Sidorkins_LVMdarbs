...
def iegut_atbildi(jautajums, izveles):
    """
    Saņem atbildi no DeepSeek API
    :param jautajums: jautājuma teksts
    :param izveles: saraksts ar atbilžu variantiem (A-D)
    :return: atbilde (A/B/C/D/X - kļūdām)
    """
    try:
...
def apstrada_testu(ievada_fails, izvada_fails):
    """
    Apstrādā testa jautājumus no CSV faila
    :param ievada_fails: ievaddatu fails
    :param izvada_fails: rezultātu fails
    """
