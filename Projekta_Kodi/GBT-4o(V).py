...
def ask_chatgpt(question, options):
    ...
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "Lūdzu, atbildi uz šo jautājumu, izvēloties vienu no piedāvātajiem atbilžu variantiem."},
...
def process_csv(input_file, output_file):
    """
    Nolasa CSV failu, uzdod jautājumus GPT, ieraksta atbildes un izveido jaunu CSV ar papildkolonnām.
    """
...
if __name__ == "__main__":
    ...
    print("Apstrāde pabeigta! Rezultāti saglabāti jautajumi_ar_atbildem.csv")
