...
class ClaudeCSVProcessor:
    def __init__(self, api_key=None):
        ...
        if not self.api_key:
            raise ValueError("API atslēga nav norādīta!")
...
Svarīgi: Atbildi tikai ar burtu (A, B, C vai D), kas apzīmē pareizo atbildi. Nesniedz nekādus paskaidrojumus."""
    ...
    def save_results(self, df, output_path=None):
        ...
        :param df: DataFrame saglabāšanai
        :param output_path: Ceļš saglabāšanai. Ja None, pievieno '_ar_atbildēm' oriģinālajam nosaukumam
        :return: Ceļš līdz saglabātajam failam
        """
